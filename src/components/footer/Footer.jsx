  ...
  return (
    <>
      ...
      <footer className="footer px-10 py-4 border-t bg-base-300 text-base-content border-base-300">
        <Link to={`/admin/dashboard`} className="items-center grid-flow-col">
          <img
          ...
          <p>
            <span className="font-semibold text-lg">
              <strong className="text-primary">Eclectics</strong> International
              Ltd.
            </span>{" "}
            <br />
          ...
          <div className="grid grid-flow-col gap-4">
            <a>
              <svg
                ...
                height={24}
                viewBox="0 0 24 24"
                className="fill-current hover:fill-primary hover:cursor-pointer"
              >
