                                            ...
                                            <div className="flex flex-1 justify-between items-center text-sm mt-2">
                                                ...
                                                <div className="flex">
                                                    <button
                                                        ...
                                                        type="button"
                                                        className="font-medium text-error hover:text-error hover:border hover:border-error hover:bg-base-100 p-3 rounded-md"
                                                    >
                                ...
                                <div className="modal">
                                    <div className="modal-box">
                                        ...
                                        <p className="py-4 italic">
                                            Signing the contract is legally
                                            binding between the buyer and the
                                            seller upon purchasing products
                                            using our platform.
                                        </p>
                                        <h3 className="font-bold sm:text-base md:text-xl">
                                            By clicking sign contract you
